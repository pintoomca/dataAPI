...
use App\User;
use JWTAuth;
class AuditorDetailXbrlController extends BaseController
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        {
            $params[] = ['Rankindex', '=', $request->Rankindex];
        }
        ...
        $companycsrs = DB::table('auditor_detailsxbrl_2017')->where($params)->get();
       ...
       $data['auditor_detail_xbrl'] = $companycsrs;
        return response()
            ->view('nfra.auditor_detail_xbrl', $data, 200)
